...
def city_search(request):
    ...
    input_string = request.GET.get('q').encode('utf8').strip()
...
def send_result(request):
    ...
    profile = Profile.objects.get(email="s.kenzhegulov@mail.ru")
